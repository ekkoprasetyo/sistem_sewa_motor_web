...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a type="button" onclick="addModal('{{ route('permission.add') }}')" class="btn btn-app">
    ...
    @include('layouts.modals.v_add', ['route' => route('permission.store')])

    @include('layouts.modals.v_edit', ['route' => route('permission.update')])

    @include('layouts.modals.v_delete', ['route' => route('permission.destroy')])
        ...
        $(function() {
            let table = $('.data-tables').DataTable({
                ...
                columns: [
                    ...
                    {data: 'c_permission_name', name: 'c_permission_name', "className": "text-center"},
                    {data: 'c_permission_display', name: 'c_permission_display', "className": "text-center"},
                    {data: 'c_permission_description', name: 'c_permission_description', "className": "text-center"},
