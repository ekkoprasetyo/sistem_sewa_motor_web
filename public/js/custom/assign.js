function assignModal(id,url_item_check) {
    $("#form-assign-js").html('');
    $.ajax({
        headers: {
    ...
    $('#modal-assign').modal({backdrop: 'static', keyboard: false});
}

$("#form-assign").on("submit", function (event) {
    event.preventDefault();

    var url  = $("#form-assign").attr('action');
