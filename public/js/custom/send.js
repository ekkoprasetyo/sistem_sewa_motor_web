function sendModal(id,url_send) {
    $("#form-send-js").html('');
    $.ajax({
        headers: {
        ...
        beforeSend : function () {
            // add overlay
            $("#overlay-send").removeAttr("hidden");
        },
...
$("#modal-send").on("hidden.bs.modal", function (event) {
    event.preventDefault();
    $("#form-send-js").html('');
